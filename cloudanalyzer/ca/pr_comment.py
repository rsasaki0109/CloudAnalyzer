...
def build_pr_comment(
    ...
    *,
    ...
    if _looks_like_check_suite(summary):
        return _format_check_suite(summary, baseline=baseline, project=project)
    if _looks_like_single_run(summary):
        return _format_single_run(summary, baseline=baseline, project=project)
    raise ValueError(
